...
/***/ function(module, exports, __webpack_require__) {
	...
	React.createElement(
	    ...
	    React.createElement(IndexRoute, { component: Headlines })
	);
	        ...
	        if (this.state.savedArticles == "") {
	            ...
	            var articles = this.state.savedArticles.map(function (article, index) {
	                ...
	                return React.createElement(
	                    ...
	                    React.createElement(
	                        'a',
	                        { href: '#/Article', role: 'button', className: 'list-group-item' },
	                        article.title
	                    )
	                );
	            }.bind(this));
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'row' },
	                    React.createElement('img', { src: 'http://randolphcountydems.org/wp-content/uploads/2016/03/news1.jpg', alt: 'News' })
	                ),
	                React.createElement(
	                    'div',
	                    { className: 'row' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
	    ...
	    getSaved: function getSaved() {
	        ...
	        return axios.get('/api/headlines').then(function (results) {
